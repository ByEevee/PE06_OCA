...
public class jocOca {
            ...
            for (int i = 0; i < numJugadors; i++) {
                ...
                if (tornsBloquejats[jugadorActual] > 0) {
                    ...
                    if (casellaJugadors[jugadorActual] == 0) {
                        // Cas especial: primera tirada amb 3-6 
                        ...
                        // Cas especial: primera tirada amb 4-5 
    ...
    public void determinarOrdre() {
        ...
        }  //doble for per ordenar l'array ordreJugadors
   ...
   public String llegirLletres() {
    ...
    public boolean processarCasella(int jugador) {
        ...
        if (casella == 5 || casella == 9 || casella == 14 || casella == 18 || 
            ...
            casella == 41 || casella == 45 || casella == 50 || casella == 54 || casella == 59)
        {
            ...
            System.out.println("Ara estàs a la casella 39.");
        } else if (casella == 52) {
